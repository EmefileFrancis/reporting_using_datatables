    ...
    <div class="row">
        <nav class="col-sm-3 col-md-2 d-none d-sm-block bg-light sidebar">
            <ul class="nav nav-pills flex-column">
                ...
                <li class="nav-item">
                    <a class="nav-link active" href="/#">WAMS Transaction<span class="sr-only">(current)</span></a>
                </li>
            </ul>
                ...
                <form action="<c:url value="/searchWamsLog"/>" method="get">
                    <div class="form-row">
                        <div class="form-group col-md-2">
                            <label for="logId" class="col-form-label">Log ID:</label>
                            <input type="text" name="id" class="form-control" id="logId" placeholder="Log ID">
                        </div>
                    ...
                    <script>
                        window.btnClicked = '';
                        window.idVar = '${wamsLogSearch.id}';
                        window.paycomVar = '${wamsLogSearch.paycomNo}';
                        window.wamsRespVar = '${wamsLogSearch.wamsResp}';
                        window.wamsResponseIDVar = '${wamsLogSearch.wamsResponseID}';
                        window.fRequest_IDVar = '${wamsLogSearch.fRequest_ID}';
                    </script>
                </form>
            </section>
