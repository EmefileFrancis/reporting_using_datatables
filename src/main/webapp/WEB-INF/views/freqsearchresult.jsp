        ...
        <main class="col-sm-9 ml-sm-auto col-md-10 pt-3" role="main">
            ...
            <section class="text-center">
                <form name="thisForm" action="<c:url value="/searchFRequest"/>" method="get" id="thisForm">
                    ...
                    <script>
                        window.btnClicked = '';
                        window.searchBasedOnCriteria = "/searchFRequestBasedOnCriteria/";
                        window.transIDVar = '${fRequstDetails.id}';
                        window.card_noVar = '${fRequstDetails.card_no}';
                        window.refNOVar = '${fRequstDetails.refNO}';
                        window.statusVar = '${fRequstDetails.status}';
                    </script>
